...
namespace GeminiReference.Blog.Modules.Posts.Domain.ValueObjects
{
    public record PostTitle : StringValueObject
    {
        ...
        public PostTitle(string value) : base(value)
        {
            Ensure.HasMaxLength(value, MAX_LENGTH, () => InvalidPostTitleLengthException.FromLength(value.Length));
            Ensure.HasMinLength(value, MIN_LENGTH, () => InvalidPostTitleLengthException.FromLength(value.Length));
